...
// configure HIHAT in this file
    ...
    define('MYSQL_HOST', '192.168.25.1');                  // host with sql-database
    define('MYSQL_USER', 'alfian');                       // username for sql-database
    define('MYSQL_PASS', 'HoneypotDB');                       // passowrd for sql-database    
    define('MYSQL_DATABASE', 'honeyweb');               // name of database with logentries
    ...
    define( 'MAX_FILESIZE', 1000000  );          // max. filesize for tools to automatically download in kbytes
