   ...
   <head>
      ...
      <script>
         $(document).ready(function() {
            ...
            function clear_all(){
               DataTableEventLog = $('#tbl_event_log').DataTable();
            }
            ...
            $('#btn_proses').click( function () {
               ...
               DataTableEventLog = $('#tbl_event_log').DataTable({
                  ...
                  "ajax":{
                     url :"../../module/event_log/data_table.php", // json datasource
      ...
      <span id="fullpage">
         ...
         <div class="container shadow-lg p-4 bg-white">
            ...
            <div class="form-group row">
               ...
               <div class="col-sm-3">
                  <button type="button" class="btn btn-sm btn-success" id="btn_proses"  data-toggle="modal" data-target="#modal_event_log">Proses</button>
               </div>
            </div>
         </div>
      </span>
